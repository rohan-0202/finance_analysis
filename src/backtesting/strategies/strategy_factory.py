...
class StrategyFactory:
    ...
    def get_strategy_class(strategy_name: str) -> Type[Strategy]:
        ...
        if not os.path.exists(strategy_path):
            raise ValueError(f"Strategy file '{strategy_name}.py' not found in '{strategies_dir}'")
        ...
        try:
            ...
            raise ValueError(f"Error loading strategy '{strategy_name}': {e}")
    ...
    def get_default_parameters(strategy_name: str) -> Dict:
        ...
        print(f"Warning: Strategy '{strategy_name}' doesn't implement get_default_parameters(). Using empty defaults.")
        return {} 